...
<template>
  ...
  >
    ...
    <div class="container mx-auto relative z-10">
      ...
      >
        <div class="relative flex flex-wrap justify-center bg-white rounded-full shadow-md p-2 overflow-hidden max-w-3xl mx-auto">
          ...
          <button 
            ...
            :key="program.id"
            class="tab-button relative z-10 px-3 sm:px-4 md:px-6 py-2 md:py-3 mx-1 rounded-full cursor-pointer transition-all duration-300 text-xs sm:text-sm md:text-base font-medium whitespace-nowrap"
        ...
        <div class="p-4 sm:p-6 md:p-8">
          <div class="flex flex-col lg:flex-row items-center gap-6 md:gap-8">
            ...
            <div class="w-full lg:w-1/3 flex justify-center mb-6 lg:mb-0">
              <div class="relative p-4 sm:p-6 rounded-full bg-gradient-to-br" :class="`from-${activeProgram.color}-light to-light`">
                <!-- English for Kids Icon -->
                <svg v-if="activeProgram.icon === 'language'" xmlns="http://www.w3.org/2000/svg" 
                  class="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 text-primary animate-float drop-shadow-lg" 
                ...
                <!-- Decorative elements -->
                <div class="absolute -top-3 -right-3 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-primary rounded-full opacity-20 animate-float" style="animation-delay: 0.3s;"></div>
                <div class="absolute -bottom-3 -left-3 w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-secondary rounded-full opacity-20 animate-float" style="animation-delay: 0.7s;"></div>
              </div>
            </div>
            ...
            <div class="w-full lg:w-2/3">
              <div class="flex flex-col md:flex-row md:items-center mb-4 md:mb-6">
                <h3 class="text-xl sm:text-2xl md:text-3xl font-bold text-secondary mb-2 md:mb-0">{{ activeProgram.title }}</h3>
                <span class="md:ml-4 px-3 sm:px-4 py-1 bg-primary-light text-primary text-xs sm:text-sm rounded-full inline-flex items-center">
              ...
              <p class="text-base sm:text-lg text-gray-700 mb-6 md:mb-8 leading-relaxed">{{ activeProgram.description }}</p>
              
              <!-- Program Features with animation -->
              <div class="bg-light rounded-lg p-4 sm:p-6 mb-6 md:mb-8">
                <h4 class="text-base sm:text-lg font-semibold text-secondary mb-3 md:mb-4 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-primary" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div class="flex flex-wrap gap-3 sm:gap-4">
                <a href="#contact" class="btn btn-sm sm:btn-md btn-primary inline-flex items-center group">
                  <span>Enroll Now</span>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 ml-2 transform transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                  </svg>
                </a>
                <button class="btn btn-sm sm:btn-md btn-outline-primary">
                  Learn More
                </button>
              </div>
            </div>
      ...
      <div 
        class="mt-10 sm:mt-12 md:mt-16 text-center transform transition-all duration-1000 delay-700 ease-out scroll-animate px-4"
        :class="isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'"
      >
        ...
        <a href="#contact" class="btn btn-sm sm:btn-md md:btn-lg btn-outline-primary shadow-hover inline-flex items-center group">
